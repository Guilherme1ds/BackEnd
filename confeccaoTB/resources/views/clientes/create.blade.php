                ...
                <form action="{{ route('clientes.store') }}" method="POST" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="cpf" value="{{ old('cpf') }}" data-mask="cpf" inputmode="numeric" maxlength="14" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm mt-1 block w-full" required>
                        ...
                        <div>
                            ...
                            <input type="text" name="telefone" value="{{ old('telefone') }}" data-mask="phone" inputmode="tel" maxlength="15" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm mt-1 block w-full" required>
